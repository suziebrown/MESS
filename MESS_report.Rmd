...
```{r}
modpar1 <- survreg(surv1 ~ as.factor(trt) + ager + as.factor(sex) + nseiz + period, mess, dist="exponential")
summary(modpar1)

modpar2 <- survreg(surv1 ~ trt + ager + sex + nseiz + period, mess, dist="weibull")
summary(modpar1)
modpar3 <- survreg(surv1 ~ trt + ager + sex + nseiz + period, mess, dist="weibull",scale = -1)
summary(modpar3)
