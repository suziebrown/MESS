...
legend("topright", c('','name'), legend = c("Kaplan - Meier", "Lognormal"), col = c(1,2), lty = c(1,1))
...
matplot(dat1, 1-percs, type="l", main="Predictive curves for baseline subject with each treatment",xlim = c(0,10), xlab="time (years)", ylab="survival probability", lty=c(1,3,3), lwd=2, col="blue", cex=0.8)
matlines(dat2, 1-percs, lty=c(1,3,3), lwd=2, col="red")
...
We could extend the log-normal model to include a scale parameter dependent on the treatment, in order to capture any difference in scale between the immediate and deferred treatment groups.
