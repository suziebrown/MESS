...
We point out that many of the variables included in the model (especially those referring to an EEG abnormality) seems to be not significant. For comprehensibility we display only the significant covariates here. 
