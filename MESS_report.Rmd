...
kable(summary(mycox)$coefficients[,c(1,2,5)], digits = 3)
```
...
kable(summary(mycox2)$coefficients[,c(1,2,5)], digits = 3)
#cox.zph(mycox2)
```
...
kable(summary(mycox3)$coefficients[,c(1,2,5)], digits = 3)
#cox.zph(mycox3)
```
...
kable(summary(mycox4)$coefficients[,c(1,2,5)], digits = 3)
#cox.zph(mycox4)
```
...
kable(summary(modpar.logn)$table, digits = 3)
```
