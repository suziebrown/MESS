...
An alternative to the Cox model is to consider a parametric specification for the distribution of survival times
...
plot(mfit.trt, conf.int = T, mark.time=F, col = 2:3, xlab = "Days since randomisation", ylab = "survival probability")
legend("topright", legend = c("Immediate","Deferred"), col = 2:3, lty=1)
mfit.sex <- survfit(surv1 ~ sex, conf.type = "log-log", data = mess)
plot(mfit.sex, conf.int = T, mark.time=F, col = c("orange","brown"), xlab = "Days since randomisation",ylab = "survival probability")
