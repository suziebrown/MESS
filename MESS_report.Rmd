...
matplot(dat1, 1-percs, type="l", main="Predictive curves for baseline subject with each treatment",xlim = c(0,10), xlab="time (years)", ylab="survival probability", lty=c(1,3,3), lwd=2, col="red", cex=0.8)
